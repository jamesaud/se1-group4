# -*- coding: utf-8 -*-
"""
Django settings for jmatcher project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (jmatcher/config/settings/common.py - 3 = jmatcher/)
APPS_DIR = ROOT_DIR.path('jmatcher')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'jmatcher.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///jmatcher'),
}
...
DATE_INPUT_FORMATS = ['%m/%d/%Y',      # '10/25/2006'
                        '%Y-%m-%d',      # '2006-10-25'
                        '%m/%d/%y']      # '10/25/06'
